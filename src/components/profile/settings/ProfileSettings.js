...
import { Context } from "../../..";
import { faUpload, faArrowLeft, faLevelDownAlt, faPenAlt } from '@fortawesome/free-solid-svg-icons';
...
const ProfileSettings = ({setModalHeading, defaultHeading, closeModal}) => {
    ...
    const render = () => {
        if (isUpdatingAvatar) {
            return (
                <UpdateAvatarPopup closeModal={handleGoBack} directly={false} fileUrlHandler={(fileDataUrl) => {
                    setUserData({...Object.assign(userData, {avatar : {name : fileDataUrl, url : fileDataUrl}})});
                    setModalHeading(defaultHeading);
                }}/>
            )
        }
        ...
        return (
            <div className="pf-settings_wrapper">
                <form className='pf-settings default-form' onChange={(e) => {
                    
                }}>
                    <div className="settings-group">
                        <div className='settings-group_name'>
                            <span>Аватар</span>
                            <div className="settings-group_name_gradient"></div>
                        </div>
                        ...
                        <div className="setting input-container">
                            <div className='setting_input'>
                                ...
                                <input 
                                    ...
                                    data-empty={userData.username ? false : true} 
                        ...
                        <div className="setting input-container">
                            <div className='setting_input'>
                                ...
                                <textarea 
                                    ...
                                    data-empty={userData.about ? false : true} 
